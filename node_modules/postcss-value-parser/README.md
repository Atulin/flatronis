...
- **value**: The divider.sass character. Either `,`, `/`, or `:` (see examples above).
- **before**: Whitespace before the divider.sass.
- **after**: Whitespace after the divider.sass.
